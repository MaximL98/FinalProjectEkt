...
//			emptyCart = false;
		...
		scrollPane.setStyle(
				"-fx-background:   linear-gradient(from 0px 0px to 0px 1000px, #a837b4, #DADF76); -fx-border-color: transparent;"
	...
	public void getBtnCancelOrder(ActionEvent event) {
		...
		if (result.get() == ButtonType.OK) {
			...
			// category is located in a ArrayList
			WindowStarter.createWindow(primaryStage, ClientController.getCurrentSystemUser(),
					"/gui/_EKConfigurationCustomerLocalOrderFrame.fxml.fxml", null,
