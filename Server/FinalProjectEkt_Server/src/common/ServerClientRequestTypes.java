...
public enum ServerClientRequestTypes {
	...
	CREATE, UPDATE, REMOVE, ADD, DISPLAY, FETCH_PRODUCTS_BY_CATEGORY, FETCH_ONLINE_ORDERS, UPDATE_ONLINE_ORDERS,ADD_PROMOTION, DISPLAY_PROMOTIONS, DISPLAY_SELECTED_PROMOTIONS, DISPLAY_ALL_PROMOTIONS;
