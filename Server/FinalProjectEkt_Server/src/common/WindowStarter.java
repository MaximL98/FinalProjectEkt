...
public class WindowStarter {
	...
	/**
	 * The createWindow method is used to create new windows in a JavaFX application.
	 * It takes in the following parameters:
	 * @param primaryStage the primary stage of the JavaFX application
	 * @param classObject the class object of the class from which the method is called
	 ...
	 * This method loads the fxml file from the given fxmlAddress using the FXMLLoader class, creates a new scene using the loaded fxml, applies the css stylesheet from cssAddress (if provided), sets the scene's title to windowTitle, set the primary stage's icon, and sets the primary stage's scene to the newly created scene.
	 * @author Rotem
	 */
